...
// import {
//   FaTools, FaCheckCircle, FaSpinner,
//   FaMoneyBillWave, FaChartLine, FaIndustry
// } from "react-icons/fa"; // تأكد من تثبيت react-icons
...
//   // إحصائية إضافية: نسبة الإنجاز
//   const completionRate = total > 0 ? ((delivered / total) * 100).toFixed(1) : 0;

//   // تجميع بيانات المراكز
//   const centersData = {};
//   orders.forEach((o) => {
//     if (!o.center) return;
//     if (!centersData[o.center]) centersData[o.center] = { count: 0, profit: 0, cost: 0 };
//     centersData[o.center].count += 1;
//     centersData[o.center].profit += o.profit || 0;
//     centersData[o.center].cost += o.repairCost || 0;
//   });

//   if (loading) return <MainLayout><div className="p-10 text-center font-bold">جاري تحميل البيانات...</div></MainLayout>;

//   return (
//     <MainLayout>
//       <div className="flex justify-between items-center mb-8">
//         <h2 className="text-3xl font-extrabold text-gray-800 tracking-tight">📊 لوحة التحكم والتقارير</h2>
//         <div className="text-sm bg-white px-4 py-2 rounded-lg shadow-sm border border-gray-100">
//           تحديث تلقائي: <span className="font-bold text-blue-600">{new Date().toLocaleDateString('ar-EG')}</span>
//         </div>
//       </div>
...
//           </div>
//           <h3 className="text-2xl font-black">{totalCost.toLocaleString()} <small>ج.م</small></h3>
//         </div>
...
//           </div>
//           <h3 className="text-2xl font-black text-green-600">{totalProfit.toLocaleString()} <small>ج.م</small></h3>
//         </div>
...
//             {total > 0 ? (totalProfit / total).toFixed(0) : 0} <small>ج.م</small>
//           </h3>
//         </div>
//       </div>
...
//           <h3 className="text-xl font-black text-gray-800">🏭 أداء مراكز الصيانة</h3>
//         </div>

//         <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
//           {Object.keys(centersData).length > 0 ? (
//             Object.keys(centersData).map((center) => (
//               <div key={center} className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
//                 <h4 className="font-black text-lg mb-4 text-indigo-900 pb-2 border-b">{center}</h4>
//                 <div className="space-y-3 text-sm">
//                   <div className="flex justify-between">
//                     <span className="text-gray-500">عدد المواتير:</span>
//                     <span className="font-bold">{centersData[center].count}</span>
//                   </div>
//                   <div className="flex justify-between">
//                     <span className="text-gray-500">التكلفة:</span>
//                     <span className="font-bold text-red-600">{centersData[center].cost.toLocaleString()} ج.م</span>
//                   </div>
//                   <div className="flex justify-between items-center bg-green-50 p-2 rounded-lg">
//                     <span className="text-green-800 font-bold">صافي الربح:</span>
//                     <span className="font-black text-green-700">{centersData[center].profit.toLocaleString()} ج.م</span>
//                   </div>
//                 </div>
//               </div>
//             ))
//           ) : (
//             <p className="text-gray-400 italic">لا توجد بيانات مراكز مرتبطة بطلبات حالياً.</p>
//           )}
//         </div>
//       </div>
//     </MainLayout>
...
// // مكون فرعي للكروت العلوية (عشان الكود يبقى أنظف)
