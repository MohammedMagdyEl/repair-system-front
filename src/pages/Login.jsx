...
export default function Login() {
  ...
  return (
    <div
      className="flex h-screen items-center justify-center bg-gray-50 font-sans"
      dir="rtl"
    >
      ...
      >
        ...
        <select
          className="border p-3 rounded-xl outline-none focus:ring-2 focus:ring-blue-400 bg-white"
          value={email}
